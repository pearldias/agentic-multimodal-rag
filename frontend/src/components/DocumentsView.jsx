...
const DOCUMENTS = [
  ...
  { name: "SYN_004_Employee_Onboarding_Guide.docx", type: "DOCX", category: "HR Onboarding", status: "Indexed & Active", source: "data/raw" },
  ...
  { name: "SYN_011_Proposal_RFP_Guidelines.docx", type: "DOCX", category: "Business Dev", status: "Indexed & Active", source: "data/raw" },
  ...
  { name: "SYN_014_Employee_Skills_Directory.xlsx", type: "XLSX", category: "Directory", status: "Indexed & Active", source: "data/raw" },
  { name: "SYN_015_Data_Protection_Privacy.pdf", type: "PDF", category: "Compliance", status: "Indexed & Active", source: "data/raw" },
  { name: "SYN_016_AI_RAG_Development_Guide.pdf", type: "PDF", category: "AI & ML", status: "Indexed & Active", source: "data/raw" },
  ...
  { name: "SYN_019_Project_POC_Catalogue.xlsx", type: "XLSX", category: "Projects", status: "Indexed & Active", source: "data/raw" },
  { name: "SYN_020_Tech_Service_Mapping.xlsx", type: "XLSX", category: "Architecture", status: "Indexed & Active", source: "data/raw" },
];

export default function DocumentsView({ onAskQuestion }) {
    ...
    <div className="documents-page" aria-label="Knowledge base documents">
      <div className="doc-page-header">
        <div className="doc-page-title-group">
          ...
          <span className="doc-count-pill">{DOCUMENTS.length} documents available</span>
        </div>
